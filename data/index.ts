...
export const gridItems = [
...

  {
    ...
    title:
      "I am a dedicated frontend developer with a passion for creating seamless web experiences",
...
export const projects = [
  {
    ...
    subtitle:
      "Travel Insurance Reinvented: Amanyaman’s Journey to Seamless Protection and Booking",
    ...
    link: [
      "https://sales-amanyaman.vercel.app",
      "https://claim-amanyaman.vercel.app",
    ],
  },
  {
    id: 2,
...
export const workExperience = [
  {
    id: 1,
    title: "Support Specialist (Remote)",
    company: "JSM (JavaScript Mastery)",
    date: "July 2024 - Now",
    desc: "Provided support to users via email and Discord, leveraging technical expertise in React, MongoDB, SQL, Next.js, and Clerk to resolve issues and explain code implementation. Efficiently handled inquiries, troubleshot problems, collaborated with the dev team, and contributed to improving customer service processes.",
  ...
  {
    id: 5,
    title: "Android Developer (Hybrid)",
